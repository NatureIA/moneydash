...
// Objetivo: incluir contas, marcar como pagas, ler cupom e criar conta automaticamente.
// Storage keys
...
function saveContas(arr){
  localStorage.setItem(STORAGE_KEY, JSON.stringify(arr))
  render()
}
function getInitial(){
  return parseFloat(localStorage.getItem(BAL_KEY) || "1000")
}
...
ocrBtn.onclick = async ()=>{
  ...
  ocrText.textContent = "Processando OCR... (pode levar alguns segundos)"
  try{
